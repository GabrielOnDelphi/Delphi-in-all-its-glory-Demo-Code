...
begin
 ...
 Caption:= (SomeObject as T3).Print('The answer to life is ')         // calls T3.Print(s)
         + (SomeObject as T4).Print(42);                              // calls T4.Print(i)
end;


procedure TfrmOverride.btnT4Click(Sender: TObject);
VAR SomeObject: T4;
begin
 SomeObject:= T4.Create;
